      ...
      <div className="container relative text-center">
        {step === "email" && (
          <>
            ...
            <form onSubmit={handleEmailSubmit} className="mx-auto mt-8 flex max-w-md flex-col sm:flex-row gap-3">
              <Input
                type="email"
                required
        ...
        {step === "extra" && (
          <>
            ...
            <h2 className="text-xl font-bold md:text-3xl" style={{ color: titleColor }}>
              Receba também as novidades direto no seu WhatsApp!
            </h2>
            <p className="mx-auto mt-3 max-w-lg text-sm md:text-lg" style={{ color: textColor }}>
              Preencha seu nome e WhatsApp para não perder nenhuma promoção.
            </p>
            <form onSubmit={handleExtraSubmit} className="mx-auto mt-8 flex max-w-md flex-col gap-3">
              <Input
                type="text"
                required
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  type="submit"
                  disabled={loading}
                  className="flex-1 h-12 px-6 font-semibold text-white shadow-lg hover:opacity-90 transition-opacity"
                  style={{ backgroundColor: buttonColor }}
                >
                ...
                <Button
                  ...
                  variant="ghost"
                  onClick={handleSkip}
                  className="h-12 px-6 font-medium hover:bg-white/10 transition-colors"
