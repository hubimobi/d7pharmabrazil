...
SELECT
    ...
    combo_offer_free_shipping,
    combo_offer_label,
    hide_chat_on_checkout,
    webchat_enabled,
    webchat_script,
    webchat_position,
    webchat_delay_seconds,
    webchat_show_on_scroll,
    whatsapp_button_enabled,
    whatsapp_button_name,
    whatsapp_button_message,
    whatsapp_position,
    whatsapp_delay_seconds,
    whatsapp_show_on_scroll,
    design_title_color,
    design_text_color,
    design_icon_color,
    design_font,
    ...
    design_border_style,
    design_bg_gradient,
    design_footer_gradient,
    design_footer_text_color,
    design_footer_title_color,
    sales_popup_enabled,
    sales_popup_position,
    sales_popup_button_color,
    sales_popup_interval_min,
    sales_popup_interval_max,
    sales_popup_burst_count,
    sales_popup_include_real_orders,
    sales_popup_custom_entries,
    max_installments,
    ...
    mailing_bg_color,
    mailing_button_color,
    mailing_text_color,
    mailing_title_color,
    cta_title,
    cta_subtitle,
    checkout_boleto_enabled,
    checkout_show_combo,
    checkout_show_free_shipping_bar,
    checkout_show_motivation,
    checkout_show_recommendations,
    checkout_show_testimonials,
    checkout_show_urgency,
    checkout_prescriber_required,
    email,
    address_city,
    address_state,
    meta_pixel_id,
