-- 1. Add tiktok_pixel_id column to store_settings table
ALTER TABLE public.store_settings ADD COLUMN IF NOT EXISTS tiktok_pixel_id text;

-- 2. Recreate store_settings_public view to include tiktok_pixel_id
...
CREATE VIEW public.store_settings_public AS
  SELECT id, store_name, display_name, attendant_name,
         ...
         meta_pixel_id, gtm_id, hotjar_id, tiktok_pixel_id
